      ...
      <div>
        ...
        <div className="rob-images-box-lg">
          <div className="rob-images-screen-box">
            <span>
              <i className="rob-icon-download-alt" onClick={this.props.handleReloadImage} />
            </span>
            <span className="error">
              <i className="rob-icon-delete" onClick={this.removeContainer} />
            </span>
            <span className="success">
              <i className="rob-icon-delete" onClick={this.props.handleCutting} />
            </span>
          </div>
