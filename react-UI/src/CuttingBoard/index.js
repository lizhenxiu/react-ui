...
class CuttingBoar extends React.PureComponent {
  ...
  handleGetCuttingBase64 = () => {
    if (!this.isFileReader) {
      ...
      console.log('计算后', `${distanceX / this.scale}, ${distanceY / this.scale}, ${selectAreaWidth}, ${selectAreaHeight}`)
      console.log('计算前', `${distanceX}, ${distanceY}, ${this.selectAreaWidth}, ${this.selectAreaHeight}`)
      return {
