...
class Calender extends Component {
  ...
  static propTypes = {
    ...
    multiSelect: PropTypes.string.isRequired, // 是否是多选
    hasFooter: PropTypes.string.isRequired, // 是否有底部
    isRange: PropTypes.string.isRequired, // 是否是日期范围
  ...
  render() {
    ...
    return (
      <div id="calendarContainer" style={this.props.isRange === 'true' ? styles.range : styles.calender} >
        <div className={'rob-calendar-panel animated'}>
          <div className={'rob-calendar-body-wrapper'}>
            ...
            <div className={'rob-calendar-panel-body'} >
              ...
              />
              {
                this.props.content === 'm' ? <Month datePick={this.datePick} year={this.state.year} month={this.state.month} /> : <Content {...props}prevMonth={this.prevMonth} nextMonth={this.nextMonth} datePick={this.datePick} year={this.state.year} month={this.state.month} day={this.state.day} isWorkday={this.props.isWorkday} multiSelect={this.props.multiSelect} pickedItem={this.props.pickedItem} pickedItems={this.props.pickedItems} multiSelectDel={this.props.multiSelectDel} />
              }
              {
                this.props.hasFooter === 'true' ? <Footer showCalender={this.props.showCalender} clearInput={this.props.clearInput} pickNow={this.props.pickNow} /> : null
              }
            </div>
          </div>
        </div>
